  ...
  return (
    <section id="contato" className="py-20 sm:py-28 px-5">
      <div className="max-w-6xl mx-auto">
        <p className="font-display font-bold uppercase text-sm tracking-[0.25em] text-cdc-accent mb-3">Contato</p>
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-wrap gap-3 mt-2">
              <a
                ...
                className="flex items-center gap-2 bg-cdc-accent hover:bg-cdc-accent-hover transition-colors text-white font-display font-bold uppercase text-sm tracking-wide px-6 py-3.5"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 border border-cdc-border hover:border-cdc-text/40 transition-colors font-display font-bold uppercase text-sm tracking-wide px-6 py-3.5"
              >
