          ...
          <div className="flex flex-col gap-6 items-center text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3 mt-2">
              <a
                ...
                className="flex items-center gap-2 bg-cdc-accent hover:bg-cdc-accent-hover hover:scale-[1.05] active:scale-[0.97] hover:shadow-lg hover:shadow-cdc-accent/25 transition-all duration-200 text-cdc-bg font-label font-semibold uppercase text-sm tracking-wide px-6 py-3.5"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2.5 rounded-full border border-cdc-border-strong bg-cdc-surface-2 hover:border-cdc-accent hover:scale-[1.05] active:scale-[0.97] transition-all duration-200 font-label font-semibold uppercase text-sm tracking-wide px-6 py-3.5"
              >
